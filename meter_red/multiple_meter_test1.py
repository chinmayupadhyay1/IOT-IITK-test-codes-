...
client = ModbusClient(method = 'rtu', port='/dev/ttyUSB1', timeout=1, stopbit=1, bytesize=8, parity='E', baudrate=9600)
client.connect()
...
while True:
        ...
        #PrintData
        print("Active Power is " +str(round(finalActP,3))+ " Watts\n")
        print("Voltage is " + str(round(finalVoltage,3))+ " volts\n")
        print("Current is " + str(round(finalCurrent,3)) + " Amps\n")
        print("Frequency is " + str(round(finalFrequency,3))+ " Hertz\n")
        print("Apparent Power is " + str(round(finalAptP,3)) + " Watts\n")
        print("Energy is " +str(round((finalWattHour/1000),3)) + " kW-Hours\n")
